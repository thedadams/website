...
"Contrast Dots" is a watchface for the [Pebble Smartwatch](http://getpebble.com). It was designed and created by me, Donnie. It displays the time in a unique way using a grid of dots. There are two sections of dots which have contrasting design. The smaller section black outlined dots on the white background are for displaying the hour. The white dots on the black background are for the minutes.
...
![Contrast Dots Screenshot 1](/assets/images/pebble-screenshot_2014-07-13_11-16-44.png){: class="py-8 mx-auto"}

![Contrast Dots Screenshot 2](/assets/images/pebble-screenshot_2014-07-13_11-17-18.png){: class="py-8 mx-auto"}
