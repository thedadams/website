  ...
  <Centered gap>
    ...
    <Centered class="ml-8">
      ...
      <ul class="list-inside list-disc ml-6">
        <li class="py-1.5"><span class="font-semibold">Desk</span>: Uplift L-Shaped Standing Desk, Bamboo,
          72"Mx60"R
        </li>
        <li class="py-1.5"><span class="font-semibold">Work Computer</span>: MacBook Pro 16" (2022) with M1 Max,
          32GB RAM, 1TB SSD
        </li>
        <li class="py-1.5"><span class="font-semibold">Secondary Work Computer</span>: Lenovo ThinkPad T14 Gen
          5, 16GB RAM, 512GB SSD
        </li>
        ...
        <li class="py-1.5"><span class="font-semibold">Watch</span>: Apple Watch Series 10, Aluminum, Jet Black,
          46mm, Cellular
        </li>
      ...
      <ul class="list-inside list-disc ml-6">
        <li class="py-1.5"><span class="font-semibold">Notebook</span>: Baron Fig Confidant, Flagship, Dot Grid
        </li>
        <li class="py-1.5"><span class="font-semibold">Pencil</span>: Stilform AEON Pure Pencil, Aluminum, Black
        </li>
        <li class="py-1.5"><span class="font-semibold">Pen</span>: Stilform FLOW Rollerball Pen, Aluminum,
          Black
        </li>
        <li class="py-1.5"><span class="font-semibold">Notebook Case</span>: Baron Fig Guardian Pro, Fig Wine
        </li>
      </ul>
      <h2 class="mt-6 text-blue-400">Software</h2>
      <ul class="list-inside list-disc ml-6">
        <li class="py-1.5"><span class="font-semibold">Launcher & Clipboard Manager</span>: Raycast</li>
        ...
        <li class="py-1.5"><span class="font-semibold">Web Browser</span>: Dia & Brave</li>
