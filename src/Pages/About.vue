		...
		<Half centered>
			...
			<template v-slot:right>
				<p>The majority of graduate students in math earn a livable wage by teaching classes for the college
					they are attending. That is exactly how I got into education. I started teaching math in the first
					year of my Master's program at San Diego State in 2008. In all, I have taught at two four-year
					universities, two two-year colleges, and one high school. I am no longer teaching professionally,
					but I plan to return to it at some point. Impacting young people's lives is one of the most
					rewarding experiences I have had.</p>
				<br>
				<p>During my education, I found programming and enjoyed it a lot. So much so, that I changed careers and
					am now a Software Engineer for a remote startup. I started learning different languages and
