...
layout: default
title: Home
content_class: home-page
---

![Donnie Adams](/assets/images/picture2.jpg){: class="mx-auto rounded-full w-48 h-48 object-cover my-4"}

# Hi, I'm Donnie
{: class="text-5xl font-bold mb-2 text-center"}
