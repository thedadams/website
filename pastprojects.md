...
- ## My blog
  ...
  After I built my website (see below), I wanted a place to write about the things I had learned. Naturally, I wanted to build my own solution rather than use another service. It turned out to be a great way to learn some PHP. The entire site consists of two HTML5 files with some PHP, Javascript, and plaintext files on the webserver. I even wrote a script that generates the RSS feed, adds new tags for the files, and uploads all the information to the webserver. I wrote about how I [created](/blog/2013/05/31/How-I-Created-This-Blog/) and [updated](/blog/2014/12/30/Blog-2.0/) my blog.
{: .project-grid}
...
- ## This website
  ...
  Most of what you see here is static, written in HTML5 and CSS3. Very small pieces are dynamic, written in PHP and Javascript. The site is somewhat "responsive," but there is nothing fancy happening. The page reads a slightly different CSS file when the screen size is less that 759 pixels wide (I forgot where I got that number).
