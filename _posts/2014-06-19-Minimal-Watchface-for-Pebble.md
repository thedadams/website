...
author: "Donnie"
---
A few months ago I was inspired to make a watchface for the [Pebble Smartwatch](http://getpebble.com). I wanted to combine an analog design with a digital one to create a very simple, uncluttered watchface. I have very little design experience and limited programming experience, but I thought that the task could be obtained with a little effort. After looking over the [Pebble API documentation](https://developer.getpebble.com/2/api-reference/modules.html), I decided to tackle the project. I have released a few upgrades since originally publishing the face on the Pebble app store; I am particularly proud of the most recent version.
