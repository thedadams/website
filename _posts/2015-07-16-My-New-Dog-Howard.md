...
author: "Donnie"
---
First, if you haven't read my first post on [animal testing](/blog/2015/03/09/Animal-Testing/), I ask that you read that before reading this post. You'll learn a little bit about animal testing, what it means to me, and what [Beagle Freedom Project](http://www.beaglefreedomproject.org) (BFP) is doing to combat the unnecessary cruelty that animals go through. One of the newest programs that BFP started is called the [Identity Campaign](http://www.identitycampaign.org). For small donation, you can "adopt" an animal in a lab, give it a name, have the option to obtain the records of the animal, and help BFP acquire it if it is released from the lab.
