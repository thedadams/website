...
<div class="max-w-6xl mx-auto px-4 py-8 space-y-8">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div>
      <h2 class="text-2xl font-bold text-blue-400 mb-3">Freelance</h2>
      <p>I decided to move my freelance work to an actual business. However, because my wife and I recently moved to Ohio, I had to dissolve the business. Once we are settled (and the snow starts falling), I am sure I have will have the time and desire to start it back up.</p>
      <br>
      <p>Previously, I built and designed websites for clients. I also extended some functionality and improved automation for a company which allowed them to grow much more quickly than they previously thought possible.</p>
    </div>
  </div>
